                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            ...
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/product-16-3.jpg') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/product-16-4.jpg') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/product-16-5.jpg') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/product-16-6.jpg') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            <div><img src="{{ asset('assets/imgs/products/thumbnail-5.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('assets/imgs/products/thumbnail-6.jpg') }}" alt="product image"></div>
